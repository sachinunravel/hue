...
<impala>LENGTH\s*\(                        { yy.lexer.unput('('); yytext = 'length'; parser.addFunctionLocation(yylloc, yytext); return '<impala>LENGTH'; }
<impala>NDV_NO_FINALIZE\s*\(               { yy.lexer.unput('('); yytext = 'ndv_no_finalize'; parser.addFunctionLocation(yylloc, yytext); return '<impala>NDV_NO_FINALIZE'; }
